...
\frametitle<2>{Selecci\'on de lluvias j\'ovenes: Area over Peak (AoP)}
\frametitle<3>{Selecci\'on de lluvias j\'ovenes}
	\begin{center}\footnotesize
		...
		\begin{textblock}{15}(0.5,2)
			\begin{alertblock}{}
				\begin{overprint}
				\onslide<1>\centerline{\textbf{13 bines temporales por sobre un nivel de se\~nal.}}
				\onslide<2->\centerline{\textbf{\'Area de la se\~nal dividida por su m\'aximo.}}
				\end{overprint}
			\end{alertblock}
		\end{textblock}
		...
		\begin{textblock}{7.3}(0.4,3.5)
			\begin{block}{Se\~nal extendida (lluvia joven)}
		...
		\begin{textblock}{7.3}(8.3,3.5)
			\begin{block}{Se\~nal angosta (lluvia vieja)}
...
% 	\pgfimage[width=0.9\textwidth]{fig/seleccionAuger/AoP_new_without_search_0.pdf}<1>
	\pgfimage[width=0.9\textwidth]{fig/seleccionAuger/AoP_new_without_search_2.pdf}<1>
